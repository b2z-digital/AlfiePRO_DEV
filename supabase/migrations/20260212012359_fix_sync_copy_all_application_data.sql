/*
  # Fix Sync Function - Copy All Application Data

  1. Problem
    - Sync function only copies name, email, phone
    - Missing: address, emergency contact, membership type, boats
    - Member records appear empty in edit modal

  2. Solution
    - Copy ALL fields from membership_applications:
      - Address (street, city, state, postcode)
      - Emergency contact details
      - Membership type
      - Boats
    - Also sync membership_type_id to club_memberships
