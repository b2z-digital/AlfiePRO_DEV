/*
  # Create Race Reports Table with Results Image Support
  ...
  1. New Tables
    - `race_reports`
      ...
      - `results_image_url` (text, URL to results screenshot)
      ...
      - `is_published` (boolean, whether report is published)
