/*
  # Fix Remittance Trigger Payment Status

  1. Issue
    - Triggers use 'completed' as payment_status
    - transactions table check constraint only accepts: 'paid', 'awaiting_payment'
    
  2. Fix
    - Change payment_status from 'completed' to 'paid' in all triggers
    - This correctly represents a completed payment
*/
