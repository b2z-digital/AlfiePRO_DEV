/*
  # Fix Remittance Trigger - Use Correct Transaction Type
  
  The trigger was using 'deposit' as the transaction type, but the constraint 
  only allows 'income' or 'expense'. This migration updates to use 'income'.
  
  1. Changes
    - Change 'deposit' to 'income' for association transactions
*/
