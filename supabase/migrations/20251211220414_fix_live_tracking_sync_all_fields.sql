/*
  # Fix Live Tracking to Sync All Event Changes

  1. Changes
    - Update trigger to watch skippers, race_results, AND heat_management
    - Ensures live tracking updates when skippers are added/removed
    - Ensures live tracking updates when results are cleared
    - Ensures live tracking updates when heat assignments change

  2. Details
    - Trigger now detects changes to any of the critical fields
    - This fixes stale data issues when resetting events or removing skippers
*/
