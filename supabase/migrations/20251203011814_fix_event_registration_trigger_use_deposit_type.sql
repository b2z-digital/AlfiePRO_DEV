/*
  # Fix Event Registration Finance Trigger - Use Deposit Type

  1. Problem
    - The trigger uses type 'income' 
    - But the transactions table constraint only allows 'deposit' or 'expense'

  2. Solution
    - Change type from 'income' to 'deposit'

  3. Changes
    - Update type to 'deposit'
*/

-- Drop and recreate the trigger function with correct type
...
BEGIN
  ...
  -- Create the transaction in transactions table using 'deposit' type
