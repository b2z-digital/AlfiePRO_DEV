/*
  # Fix Marketing List Column References
  
  Updates all functions that reference the old 'subscriber_count' column
  to use the new 'total_contacts' column name.
  
  1. Changes
    - Update ensure_all_members_list function
    - Update sync_member_to_marketing_list function  
    - Update remove_member_from_marketing_list function
*/
