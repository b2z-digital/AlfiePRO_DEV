/*
  # Fix start_impersonation_session function

  1. Bug Fix
    - Fixed reference to non-existent column `user_metadata` 
    - Changed to correct column name `raw_app_meta_data` in auth.users table
    - This was causing a 400 error when trying to impersonate a user
*/
