/*
  # Fix Remittance Sync Function - Remove Color Column

  This migration fixes the sync_remittance_status_to_club function to remove
  the color column which doesn't exist in budget_categories table.

  1. Changes
    - Removes color field from INSERT statement
    - Uses correct budget_categories schema

  2. Security
    - Maintains SECURITY DEFINER with proper search_path
*/

-- Fix the sync function without the color column
