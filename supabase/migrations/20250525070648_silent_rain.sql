/*
  # Add media storage and columns for race series

  1. Changes
    - Create storage bucket for event media
    - Add media JSONB column to race_series
    - Add livestream_url column to race_series
  ...
  2. Notes
    ...
    - Maintains consistent permissions model
*/
