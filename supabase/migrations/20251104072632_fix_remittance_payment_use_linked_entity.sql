/*
  # Fix Remittance Payment Tracking - Use Linked Entity Fields

  This migration fixes the sync function to use the correct linked_entity fields
  instead of the non-existent is_remittance_payment column.

  1. Changes
    - Replaces is_remittance_payment with linked_entity_type and linked_entity_id
    - Uses 'remittance' as the entity type
    - Links to the remittance ID for proper tracking

  2. Security
    - Maintains SECURITY DEFINER with proper search_path
*/

-- Fix the sync function to use correct transaction schema
