/*
  # Fix Remittance Trigger Payment Method

  1. Issue
    - Trigger uses 'transfer' as payment_method
    - transactions table only accepts: 'cash', 'card', 'cheque', 'bank', 'other'
    
  2. Fix
    - Change payment_method from 'transfer' to 'bank' in both triggers
    - This represents bank transfer/electronic transfer
*/
