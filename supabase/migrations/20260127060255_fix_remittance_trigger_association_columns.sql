/*
  # Fix Remittance Trigger - Use Correct Association Transaction Columns
  
  The trigger was referencing columns that don't exist in association_transactions table.
  ...
  1. Changes
    ...
    - Remove 'club_id' and 'club_name' as they don't exist
    - Remove 'created_by' as it doesn't exist
*/
